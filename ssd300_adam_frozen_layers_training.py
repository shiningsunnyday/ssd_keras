...
model_checkpoint = ModelCheckpoint(filepath='./models/belgas_relabelled_sgd_frozen/epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
                                   ...
                                   mode='auto',
                                   period=10)
csv_logger = CSVLogger(filename='belgas_relabelled_sgd_frozen_training_log.csv',
                       separator=',',
                       append=True)
