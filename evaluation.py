...
from models.keras_ssd300_tflite import ssd_300
...
# sample code
# python ssd300_evaluation.py --model_file=models/combined/baseline_5_64.h5 --images_dir=../datasets --labels_path=../datasets/combined_train.csv --classes=../datasets/combined_classes.txt