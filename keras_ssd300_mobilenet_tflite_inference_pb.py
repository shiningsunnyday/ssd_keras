...
from models.inference_layers import DecodeDetections, L2Normalization, PriorBoxes
...
def ssd_300(image_size,
    ...
    #     return tensor - tf.convert_to_tensor(subtract_mean,dtype=tf.float32)
    ...
    def l2_norm(tensor):
        ...
        # gamma = K.variable(20 * tf.expand_dims(tf.ones(tf.shape(tensor)[axis]),-1), name='{}_gamma'.format('conv4_3_norm'))
        # return K.l2_normalize(tensor, axis) * gamma
        return K.l2_normalize(tensor, axis) * 20
    ...
    x = Input(shape=(img_height, img_width, img_channels))  # assuming the above was implemented pre-processing
    ...
    conv5_1 = SeparableConv2D(512, (3, 3), activation='relu', padding='same', depthwise_initializer='he_normal',
                              kernel_regularizer=l2(l2_reg), name='conv5_1_separable2d')(pool4)
    ...
    conv5_2 = SeparableConv2D(512, (3, 3), activation='relu', padding='same', depthwise_initializer='he_normal',
                              kernel_regularizer=l2(l2_reg), name='conv5_2_separable2d')(conv5_1)
    ...
    conv5_3 = SeparableConv2D(512, (3, 3), activation='relu', padding='same', depthwise_initializer='he_normal',
                              kernel_regularizer=l2(l2_reg), name='conv5_3_separable2d')(conv5_2)
    ...
    conv8_1 = SeparableConv2D(128, (1, 1), activation='relu', padding='same', depthwise_initializer='he_normal',
                              kernel_regularizer=l2(l2_reg), name='conv8_1_separable2d')(conv7_2)
    ...
    conv8_2 = SeparableConv2D(256, (3, 3), strides=(1, 1), activation='relu', padding='valid',
                              depthwise_initializer='he_normal', kernel_regularizer=l2(l2_reg),
                              name='conv8_2_separable2d')(conv8_1)
    ...
    conv9_1 = SeparableConv2D(128, (1, 1), activation='relu', padding='same', depthwise_initializer='he_normal',
                              kernel_regularizer=l2(l2_reg), name='conv9_1_separable2d')(conv8_2)
    ...
    conv9_2 = SeparableConv2D(256, (3, 3), strides=(1, 1), activation='relu', padding='valid',
                              depthwise_initializer='he_normal', kernel_regularizer=l2(l2_reg),
                              name='conv9_2_separable2d')(conv9_1)
