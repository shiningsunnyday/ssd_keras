...
def ssd_512(image_size,
    ...
    conv6_2_mbox_priorbox = Lambda(anchor_boxes,
                                   output_shape=tuple(map(int, conv6_2_mbox_loc.shape[1:-1])) + tuple([n_boxes[2], 8]),
                                   arguments={'index': 2}, name='conv6_2_mbox_priorbox')(conv6_2_mbox_loc)
    conv7_2_mbox_priorbox = Lambda(anchor_boxes,
                                   output_shape=tuple(map(int, conv7_2_mbox_loc.shape[1:-1])) + tuple([n_boxes[3], 8]),
                                   arguments={'index': 3}, name='conv7_2_mbox_priorbox')(conv7_2_mbox_loc)
    conv8_2_mbox_priorbox = Lambda(anchor_boxes,
                                   output_shape=tuple(map(int, conv8_2_mbox_loc.shape[1:-1])) + tuple([n_boxes[4], 8]),
                                   arguments={'index': 4}, name='conv8_2_mbox_priorbox')(conv8_2_mbox_loc)
    conv9_2_mbox_priorbox = Lambda(anchor_boxes,
                                   output_shape=tuple(map(int, conv9_2_mbox_loc.shape[1:-1])) + tuple([n_boxes[5], 8]),
                                   arguments={'index': 5}, name='conv9_2_mbox_priorbox')(conv9_2_mbox_loc)
    conv10_2_mbox_priorbox = Lambda(anchor_boxes,
                                   output_shape=tuple(map(int, conv10_2_mbox_loc.shape[1:-1])) + tuple([n_boxes[6], 8]),
                                   arguments={'index': 6}, name='conv10_2_mbox_priorbox')(conv10_2_mbox_loc)
    ...
    if mode == 'training':
        ...
        decoded_predictions = Lambda(decode_detections_fast, output_shape=(top_k, 6), name='decoded_predictions')(
            predictions)
        model = Model(inputs=x, outputs=decoded_predictions)
    else:
