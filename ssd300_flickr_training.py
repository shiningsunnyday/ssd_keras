...
n_classes = 47 # Number of positive classes, e.g. 20 for Pascal VOC, 80 for MS COCO
...
flickr_train_dir = '../datasets/FlickrLogos_47'
flickr_test_dir = '../datasets/FlickrLogos_47'
flickr_train_labels = '../datasets/FlickrLogos_47/flickr_train_labels.csv'
flickr_test_labels = '../datasets/FlickrLogos_47/flickr_val_labels.csv'

classes = np.loadtxt("../datasets/FlickrLogos_47/classes.txt", dtype=str)

train_dataset.parse_csv(flickr_train_dir,flickr_train_labels,['image_name','xmin','xmax','ymin','ymax','class_id'])
val_dataset.parse_csv(flickr_test_dir,flickr_test_labels,['image_name','xmin','xmax','ymin','ymax','class_id'])
