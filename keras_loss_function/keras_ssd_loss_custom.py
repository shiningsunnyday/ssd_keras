...
class SSDLoss:
    ...
    def __init__(self,
        ...
        self.alpha = alpha
        self.pos_class_ratio = pos_class_ratio
    ...
    def log_loss(self, y_true, y_pred):
        ...
        if self.weighted_method == 0:
            log_loss = -tf.reduce_sum(y_true * tf.log(y_pred), axis=-1)
            return log_loss
        elif self.weighted_method == 1:
    ...
    def compute_loss(self, y_true, y_pred):
        ...
        self.pos_class_ratio = tf.constant(self.pos_class_ratio)
        ...
        class_loss = self.pos_class_ratio * pos_class_loss + (2.0-self.pos_class_ratio) * neg_class_loss # Tensor of shape (batch_size,)
        ...
        total_loss = ((2.0 - self.alpha) * class_loss + self.alpha * loc_loss) / tf.maximum(1.0, n_positive) # In case `n_positive == 0`
